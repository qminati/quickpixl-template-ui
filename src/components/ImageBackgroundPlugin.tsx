...
interface ImageBackgroundPluginProps {
  isExpanded: boolean;
  onToggleExpanded: () => void;
  onAddVariation: (variation: Variation) => void;
}

const ImageBackgroundPlugin: React.FC<ImageBackgroundPluginProps> = ({
  isExpanded,
  onToggleExpanded,
  onAddVariation,
}) => {
    ...
    <div className="bg-card border border-panel-border rounded-lg shadow-sm">
      ...
      >
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm font-medium text-foreground">Image Container Background</span>
        </div>
        {isExpanded ? (
...
export default ImageBackgroundPlugin;